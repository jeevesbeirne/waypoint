...
export default function WelcomeScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      {/* Subtle gradient banner bridging from dark splash → light theme */}
      <LinearGradient
        colors={['rgba(15,27,45,0.12)', 'transparent']}
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.frameworkBox}>
          ...
          <Text style={styles.frameworkBody}>
            ...
            practice. The research in this app is drawn from Watkins' work, alongside findings from
            Harvard Business Review and McKinsey &amp; Company.
          </Text>
        </View>
